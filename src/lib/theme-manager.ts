...
const PRESETS: ThemePresetConfig[] = [
  { id: ThemePreset.Midnight, label: "Midnight", font: "Geist",          accent: "#ff7e5f", base: "#0a0a0a", surface: "#111111" },
  ...
  { id: ThemePreset.Crimson,  label: "Crimson",  font: "Inter",           accent: "#ff4632", base: "#1d1d1d", surface: "#292929" },
];
