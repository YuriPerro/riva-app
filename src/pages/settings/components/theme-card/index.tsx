  ...
  return (
    ...
    >
      <div className="flex flex-col" style={{ backgroundColor: preset.base }}>
        <div className="flex items-center gap-2 px-3 py-2" style={{ backgroundColor: preset.surface }}>
          <div className="h-2 w-2 rounded-full" style={{ backgroundColor: preset.accent }} />
          <span className="text-[11px] font-medium text-fg" style={{ fontFamily: preset.font }}>
            {preset.label}
          </span>
        ...
        <div className="flex gap-2 px-3 py-3">
          <div className="flex flex-1 flex-col gap-1.5 rounded-md p-2" style={{ backgroundColor: preset.surface }}>
            <div className="h-1.5 w-3/4 rounded-full" style={{ backgroundColor: preset.accent, opacity: 0.8 }} />
          ...
          <div className="flex flex-1 flex-col gap-1.5 rounded-md p-2" style={{ backgroundColor: preset.surface }}>
            ...
            <div className="h-4 w-full rounded" style={{ backgroundColor: preset.accent, opacity: 0.15 }} />
        ...
        >
          <span className="text-[10px] text-fg-muted" style={{ fontFamily: preset.font }}>
            {preset.font}
          </span>
