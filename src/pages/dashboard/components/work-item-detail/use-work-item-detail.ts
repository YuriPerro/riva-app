...
function mapToDisplay(detail: WorkItemDetail): DisplayDetail {
  ...
  return {
    ...
    assignee: extractDisplayName(fields['System.AssignedTo'] as { displayName: string } | null),
    ...
    createdBy: extractDisplayName(fields['System.CreatedBy'] as { displayName: string } | null, 'Unknown'),
