...
export function RunRow(props: RunRowProps) {
  ...
  return (
    ...
    >
      ...
      <span className="w-24 shrink-0 font-mono text-[11px] text-fg-disabled">
        #{run.buildNumber}
      </span>
      ...
      <span className="w-14 shrink-0 text-right text-[11px] text-fg-disabled">
        {run.duration}
      </span>

      <span className="w-16 shrink-0 text-right text-[11px] text-fg-disabled">
        {run.ago}
      </span>
    </button>
  );
